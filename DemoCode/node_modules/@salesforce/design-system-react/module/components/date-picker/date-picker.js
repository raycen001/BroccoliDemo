...
import Input from '../input'; // This component's `checkProps` which issues warnings to developers about properties
...
var defaultProps = {
  ...
  parser: function parser(str) {
    lowPriorityWarning(false, "Please use an external library for date parsing and internationalization like MomentJS (https://github.com/moment/moment/) instead of the default parser.");
    return new Date(str);
  },
  relativeYearFrom: -10,
  relativeYearTo: 10,
...
function (_React$Component) {
  ...
  function Datepicker(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Datepicker).call(this, props)); // Please remove `strValue` on the next breaking change.
    ...
    _defineProperty(_assertThisInitialized(_this), "getDatePicker", function (_ref) {
      ...
      return (
        /*#__PURE__*/
        React.createElement(CalendarWrapper // Please remove `abbrWeekDayLabels` on the next breaking change.
        , {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDialog", function (_ref2) {
      ...
      return !_this.props.disabled && _this.getIsOpen() ?
      /*#__PURE__*/
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function (_ref3) {
      ...
      var defaultInputProps = {
        iconRight:
        /*#__PURE__*/
        React.createElement(InputIcon // Remove || for assistiveText at next breaking change
        , {
          assistiveText: {
  ...
  _createClass(Datepicker, [{
    ...
    value: function render() {
      ...
      var inputToRender = this.props.children ?
      /*#__PURE__*/
      React.cloneElement(this.props.children, _objectSpread({}, inputProps)) :
      /*#__PURE__*/
