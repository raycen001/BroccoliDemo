...
describe('RadioButtonGroup', function () {
  ...
  it('renders a radio button group', function () {
    wrapper = mount(
    /*#__PURE__*/
    React.createElement(RadioButtonGroupExample, null), {
      attachTo: mountNode
    });
    ...
    radios.forEach(function (radioWrapper, index) {
      ...
      expect(radio.props.checked).to.equal(radio.props.labels.label === 'Tue', 'the second radio input is checked');
    });
  ...
  it('renders a disabled state', function () {
    wrapper = mount(
    /*#__PURE__*/
    React.createElement(RadioButtonGroupExample, {
      disabled: true
    }), {
      attachTo: mountNode
    });
