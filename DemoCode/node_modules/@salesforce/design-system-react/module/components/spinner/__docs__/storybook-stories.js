...
var inlineContainerStyle = {
  height: '4rem'
};

var inlineContainer = function inlineContainer(getStory) {
  return (
    /*#__PURE__*/
    React.createElement("div", {
...
}).add('Brand Xx-Small', function () {
  return getSpinner({
    size: 'xx-small',
    variant: 'brand'
  });
}).add('Brand X-Small', function () {
  return getSpinner({
    size: 'x-small',
    variant: 'brand'
  });
