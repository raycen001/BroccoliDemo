...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function buttonIcon(renderIcon, status, props) {
      ...
      var stepButton = props.isDisabled ?
      /*#__PURE__*/
      ...
      /*#__PURE__*/
      React.createElement(React.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, "- ".concat(status)))) :
      /*#__PURE__*/
      ...
      /*#__PURE__*/
      React.createElement(React.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, status ? " - ".concat(status) : '')));
      return stepButton;
    }
  }, {
    key: "render",
