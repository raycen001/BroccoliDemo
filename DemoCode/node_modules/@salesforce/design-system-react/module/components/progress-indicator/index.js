...
function findStep(item, items) {
  ...
  return !!find(itemsArray, function (arrayItem) {
    if (arrayItem === item) {
      return true;
    }
...
function (_React$Component) {
  ...
  function ProgressIndicator(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ProgressIndicator).call(this, props));
  ...
  _createClass(ProgressIndicator, [{
    ...
    value: function render() {
      ...
      var StepComponent = orientation === 'vertical' ? StepVertical : Step;
      /** 2. return DOM */
