...
function (_React$Component) {
  ...
  _createClass(SplitViewListbox, [{
    ...
    value: function header() {
      return this.props.labels.header ? this.headerWrapper(
      /*#__PURE__*/
      ...
      /*#__PURE__*/
      React.createElement("span", null, this.props.labels.header, this.sortDirection()),
      /*#__PURE__*/
      React.createElement("span", {
        className: "slds-assistive-text"
    ...
    value: function listItems() {
      ...
      return this.props.options.map(function (item, index) {
        return (
          /*#__PURE__*/
          React.createElement(ListItemWithContent, {
            key: item.id || index,
            assistiveText: {
