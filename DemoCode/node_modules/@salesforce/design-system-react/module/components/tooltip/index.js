  ...
  _createClass(Tooltip, [{
    ...
    value: function getAnchoredNubbinStyles() {
      if (this.props.hasAnchoredNubbin) {
        ...
        return (
          ...
          /*#__PURE__*/
          React.createElement("style", null, "#".concat(this.getId(), ":after, #").concat(this.getId(), ":before {\n\tdisplay: none;\n}")), this.getIsOpen() ?
          /*#__PURE__*/
    ...
    value: function getTooltipContent() {
      return (
        ...
        }, this.props.content, this.props.variant === 'learnMore' && this.props.onClickTrigger ?
        /*#__PURE__*/
        React.createElement("div", {
