...
function (_React$Component) {
  ...
  function Example() {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleNoHeaderIsOpen", function () {
      _this.setState({
        noHeaderIsOpen: !_this.state.noHeaderIsOpen
      });
    });

    _defineProperty(_assertThisInitialized(_this), "toggleNofooterIsOpen", function () {
      _this.setState({
        noFooterIsOpen: !_this.state.noFooterIsOpen
      });
    });
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      var modal = this.state.noHeaderIsOpen ?
      /*#__PURE__*/
