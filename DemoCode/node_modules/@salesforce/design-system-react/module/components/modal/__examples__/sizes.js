...
function (_React$Component) {
  ...
  function Example() {
    ...
    _defineProperty(_assertThisInitialized(_this), "toggleOpenLarge", function () {
      _this.setState({
        isLargeOpen: !_this.state.isLargeOpen
      });
    });

    _defineProperty(_assertThisInitialized(_this), "toggleOpenMedium", function () {
      _this.setState({
        isMediumOpen: !_this.state.isMediumOpen
      });
    });

    _defineProperty(_assertThisInitialized(_this), "toggleOpenSmall", function () {
      _this.setState({
        isSmallOpen: !_this.state.isSmallOpen
      });
    });
    ...
    value: function render() {
      ...
      return (
        ...
        React.createElement(Button, {
          ...
          onClick: this.toggleOpenSmall
        }),
        /*#__PURE__*/
        React.createElement(Button, {
          label: "Open medium modal",
          onClick: this.toggleOpenMedium
        }),
        /*#__PURE__*/
        React.createElement(Button, {
          label: "Open large modal",
          onClick: this.toggleOpenLarge
        }),
        /*#__PURE__*/
