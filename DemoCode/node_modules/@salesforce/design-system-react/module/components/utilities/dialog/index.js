...
import isEqual from 'lodash.isequal'; // ### classNames
...
import { DIALOG } from '../../../utilities/constants'; // #### Dialog doesn't pass down <IconSettings> context so repassing it here.

import IconSettings from '../../icon-settings'; // eslint-disable-next-line camelcase
...
function (_React$Component) {
  ...
  function Dialog() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getPopperStyles", function () {
      ...
      var nubbinOffsets = _this.props.hasNubbin ? getNubbinMargins(_this.state.popperData) : {
        left: 0,
        top: 0
      };
    ...
    _defineProperty(_assertThisInitialized(_this), "createPopper", function () {
      ...
      var placement = mapPropToPopperPlacement(_this.props.align, _this.props.direction);
      ...
      var modifiers = {
        ...
        updateState: {
          ...
          fn: function fn(popperData) {
            if (_this.state.popperData && !isEqual(popperData.offsets, _this.state.popperData.offsets) || !_this.state.popperData) {
              _this.setState({
      ...
      _this.popper = new Popper(reference, popper, {
        placement: placement,
  ...
  _createClass(Dialog, [{
    ...
    value: function render() {
      ...
      var contents =
      /*#__PURE__*/
      React.createElement(outerTag, _objectSpread({
      ...
      var subRenders = {
        ...
        overflowBoundaryElement: function overflowBoundaryElement() {
          ...
          var truthyIconSettingsContext = Object.keys(IconSettings.childContextTypes).filter(function (key) {
          ...
          /*#__PURE__*/
          React.createElement(IconSettings, truthyIconSettingsContext, contents));
          return (
            /*#__PURE__*/
...
_defineProperty(Dialog, "propTypes", {
   ...
   */
  contentsClassName: PropTypes.oneOfType([PropTypes.array, PropTypes.object, PropTypes.string]),
