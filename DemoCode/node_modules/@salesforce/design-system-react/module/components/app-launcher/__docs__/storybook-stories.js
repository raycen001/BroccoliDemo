  ...
  _createClass(DemoAppLauncherExpandableSection, [{
    ...
    value: function render() {
      ...
      return (
        ...
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Accounts"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Announcements"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Approvals"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Campaigns"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Cases"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Coaching"),
        /*#__PURE__*/
        React.createElement(AppLauncherLink, null, "Contacts")))
      );
    }
  }]);
...
storiesOf(APP_LAUNCHER, module).addDecorator(function (getStory) {
  ...
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncher, null)
  );
}).add('App Launcher (open)', function () {
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncher, {
      isOpen: true
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncherNoHeaderButton, null)
  );
}).add('App Launcher no search', function () {
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncherNoSearch, null)
  );
}).add('App Launcher with several sections (non-collapsible)', function () {
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncherWithSeveralSections, null)
  );
}).add('Tile', function () {
  return (
    /*#__PURE__*/
  ...
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncherExpandableSection, null)
  );
}).add('Link', function () {
  return (
    /*#__PURE__*/
    React.createElement(DemoAppLauncherLink, null)
  );
}).add('Doc site example', function () {
  return (
    /*#__PURE__*/
    React.createElement(DefaultExample, null)
  );
});
