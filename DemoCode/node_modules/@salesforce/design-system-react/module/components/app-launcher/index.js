...
function (_React$Component) {
  ...
  function AppLauncher(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AppLauncher).call(this, props));
    ...
    _defineProperty(_assertThisInitialized(_this), "openAppLauncher", function (event) {
      ...
      if (isFunction(_this.props.triggerOnClick)) {
  ...
  _createClass(AppLauncher, [{
    ...
    value: function render() {
      ...
      }, this.props.title), this.renderSearch(), this.props.modalHeaderButton ? this.props.modalHeaderButton :
      /*#__PURE__*/
      ...
      return (
        ...
        }, this.props.children), this.props.triggerName ?
        /*#__PURE__*/
        React.createElement("span", {
...
_defineProperty(AppLauncher, "displayName", APP_LAUNCHER);
