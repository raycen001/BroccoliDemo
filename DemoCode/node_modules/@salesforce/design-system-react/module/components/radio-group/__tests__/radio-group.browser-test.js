...
describe('RadioGroup', function () {
  ...
  it('renders a radio group', function () {
    wrapper = mount(
    /*#__PURE__*/
    React.createElement(RadioGroupExample, null), {
      attachTo: mountNode
    });
    ...
    radios.forEach(function (radioWrapper, index) {
      ...
      expect(radio.props.checked).to.equal(radio.props.labels.label === 'Radio Label One', 'the second radio input is checked');
    });
  ...
  it('renders a disabled state', function () {
    wrapper = mount(
    /*#__PURE__*/
    React.createElement(RadioGroupExample, {
      disabled: true
    }), {
      attachTo: mountNode
    });
