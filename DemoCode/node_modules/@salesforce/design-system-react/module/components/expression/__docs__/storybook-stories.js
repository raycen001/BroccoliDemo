...
storiesOf(EXPRESSION, module).addDecorator(function (getStory) {
  ...
  return (
    /*#__PURE__*/
    React.createElement(ResourceSelected, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(MultipleConditions, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(CustomLogic, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(FormulaLogic, {
      action: action
    })
  );
});
