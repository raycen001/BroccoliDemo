      ...
      return (
        ...
        React.createElement(Carousel, {
          ...
          onRequestAutoplayToggle: function onRequestAutoplayToggle(event, data) {
            ...
            _this2.setState({
              isAutoplayOn: !data.isAutoplayOn
            });
          },
          onRequestPanelChange: function onRequestPanelChange(event, data) {
            ...
            _this2.setState({
              currentPanel: data.requestedPanel
            });
          }
        })))
      );
...
_defineProperty(Example, "displayName", 'ThreeItemsControlledExample');

export default Example;
//# sourceMappingURL=three-items-controlled.js.map