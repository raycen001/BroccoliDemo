...
storiesOf(CAROUSEL, module).add('Default (1 item) NoImageTest', function () {
  ...
  return (
    /*#__PURE__*/
    React.createElement(DefaultWithNavigation, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(DefaultWithAutoplay, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(ThreeItems, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(ThreeItemsControlled, {
      action: action
    })
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(WithCustomItems, {
      action: action
    })
  );
});
