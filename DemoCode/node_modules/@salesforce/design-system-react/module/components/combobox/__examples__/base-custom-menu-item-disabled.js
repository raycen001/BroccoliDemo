...
var CustomMenuItem = function CustomMenuItem(props) {
  var disabledRule = {
    'slds-disabled-text': props.option.disabled
  };
  return (
    /*#__PURE__*/
    ...
    React.createElement("span", {
      className: classNames('slds-listbox__option-text', 'slds-listbox__option-text_entity', disabledRule)
    }, props.option.label),
    /*#__PURE__*/
    React.createElement("span", {
      className: classNames('slds-listbox__option-meta', 'slds-listbox__option-meta_entity', disabledRule)
    }, props.option.subTitle || "\xA0"))
  );
};
...
//# sourceMappingURL=base-custom-menu-item-disabled.js.map