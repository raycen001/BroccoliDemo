...
var entityWithIcon = entities.map(function (elem) {
  return _objectSpread({}, elem, {
    icon:
    /*#__PURE__*/
    React.createElement(Icon, {
...
function (_React$Component) {
  ...
  function Example(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "entityCombobox", function () {
      return (
        /*#__PURE__*/
        React.createElement(Combobox, {
          ...
          events: {
            onChange: function onChange(event, _ref) {
              ...
              _this.props.action('onChange')(event, value);
            ...
            onSubmit: function onSubmit(event, _ref2) {
              ...
              _this.setState({
                entityInputValue: '',
                entitySelection: [].concat(_toConsumableArray(_this.state.entitySelection), [{
                  label: value,
                  icon:
                  /*#__PURE__*/
                  React.createElement(Icon, {
            ...
            onSelect: function onSelect(event, data) {
              if (_this.props.action) {
                _this.props.action('onSelect').apply(void 0, [event].concat(_toConsumableArray(Object.keys(data).map(function (key) {
                  return data[key];
                }))));
              } else if (console) {
          ...
          options: comboboxFilterAndLimit({
            inputValue: _this.state.entityInputValue,
            options: entityWithIcon,
            selection: _this.state.entitySelection
          }),
          selection: _this.state.entitySelection,
          value: _this.state.entityInputValue,
          variant: "readonly"
        })
      );
    });
      ...
      return (
        ...
        React.createElement(Combobox, {
          ...
          events: {
            ...
            onSubmit: function onSubmit(event, _ref4) {
...
//# sourceMappingURL=inline-single-entity-combobox.js.map