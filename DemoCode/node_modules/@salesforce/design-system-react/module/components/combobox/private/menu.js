...
var setBold = function setBold(label, searchTerm) {
  ...
  if (position > -1) {
    return (
      /*#__PURE__*/
      React.createElement(React.Fragment, null, label.substr(0, position),
      /*#__PURE__*/
...
var Menu = function Menu(props) {
  ...
  var menuOptions = getOptions(props).map(function (optionData, index) {
    ...
    var menuItem = {
      ...
      }, optionData.icon) : null, props.onRenderMenuItem ?
      /*#__PURE__*/
    ...
    if (optionData.disabled && props.tooltipMenuItemDisabled) {
      ...
      item =
      /*#__PURE__*/
      React.cloneElement(props.tooltipMenuItemDisabled, tooltipProps, menuItem[props.variant]);
    } else {
  ...
  return (
    ...
    }, props.labels.noOptionsFound)), props.hasMenuSpinner &&
    /*#__PURE__*/
    React.createElement("li", {
      role: "presentation",
      className: "slds-listbox__item"
