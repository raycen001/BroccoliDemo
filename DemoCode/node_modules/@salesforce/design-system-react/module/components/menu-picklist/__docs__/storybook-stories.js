...
var getPicklist = function getPicklist(props) {
  return (
    ...
    /*#__PURE__*/
    React.createElement(Picklist, props),
    /*#__PURE__*/
...
storiesOf(MENU_PICKLIST, module).addDecorator(function (getStory) {
  ...
  return (
    /*#__PURE__*/
    React.createElement(MultipleExample, null)
  );
  ...
  return (
    /*#__PURE__*/
    React.createElement(SnapshotDefault, null)
  );
}).add('Docs site TooltipListItem', function () {
  return (
    /*#__PURE__*/
    React.createElement(TooltipListItem, null)
  );
});
