  ...
  _createClass(Step, [{
    ...
    value: function renderMediaContent() {
      return (
        ...
        }, this.props.onRenderAction ? this.props.onRenderAction() : null, this.props.estimatedTime ?
        /*#__PURE__*/
    ...
    value: function renderSummary() {
      ...
      if (this.props.onRenderFigure) {
        ...
        if (figure && figure.type && figure.type.displayName === ICON) {
          ...
          figure =
          /*#__PURE__*/
          React.cloneElement(figure, _objectSpread({}, figure.props, {
      ...
      return (
        ...
        }, figure, this.props.isExpandable || this.props.progress !== undefined ?
        /*#__PURE__*/
        React.createElement("div", {
