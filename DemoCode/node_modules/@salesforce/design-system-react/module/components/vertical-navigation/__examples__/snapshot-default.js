...
import React from 'react'; // Higher Order Components such as `react-onclickoutside` use the DOM and Jest snapshot testing must be DOMless
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      return (
        ...
        /*#__PURE__*/
        React.createElement(VerticalNavigation, _extends({
